...
*Comprising of Melbourne Museum (with Bunjilaka), Scienceworks, the Immigration Museum, and the Royal Exhibition Building, and hosting two million visitors annually. Museums Victoria is the largest museums organisation in Australasia.*

## Nodel Project

I worked primary on the integration of hardware, and development of new Python 🐍 "recipes" as part of a project to replace a legacy software system responsible for control, monitoring and scheduling for around 400 exhibits (that's ~2000 pieces of networked audio-visual equipment) across all venues.
...
- The design of the site (SketchUp) and assisted in the build (signal flow, manual handling, assembly) for the audio-visual production company running the inaugural season of [Piknic Électronik](https://piknicelectronik.com/melbourne/), an electronic music festival ran throughout the Melbourne summer.
...
- The supervision and coordination of a dozen sub-contracted staff members involved with the stage build and sound reinforcement for the flagship venue of [Melbourne Museum Week](https://mmw.melbourne.vic.gov.au/), an eight day music festival presented by the City of Melbourne. 
